...
public class OverdueNotificationController implements Initializable {
    ...
    private void checkForMailServerConfig() {
        ...
        if (mailServerInfo == null || !mailServerInfo.validate()) {
            System.out.println("El Servidor de Correo NO está Configurado");
            AlertMaker.showMaterialDialog(rootPane, contentPane, ImmutableList.of(button), "El Servidor de Correo NO está Configurado", "Por Favor Configure el Servidor de Correo.\nDisponible en Configuración");
        }
    }
